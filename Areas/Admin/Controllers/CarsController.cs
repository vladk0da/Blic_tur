...
namespace Blic_tur.Areas.Admin.Controllers
{
    ...
    public class CarsController : Controller
    {
        ...
        public CarsController(BlicTourContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Title,TypeCar,Number_of_the_car,Capacity,Comment")] Car car)
        {
            if (id != car.Id)
            {
                return NotFound();
